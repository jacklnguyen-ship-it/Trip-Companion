(function(){
  ...
  function renderCompanion(){
    ...
    var jumpLinks=cheeseMount.querySelectorAll('.companion-jump a');
    jumpLinks[0].addEventListener('click',function(event){event.preventDefault();location.hash='page-picnic';requestAnimationFrame(function(){requestAnimationFrame(function(){document.getElementById('fromagerie-checklist').scrollIntoView({behavior:'smooth',block:'start'});});});});
    jumpLinks[1].addEventListener('click',function(event){event.preventDefault();document.getElementById('cheese-passport').scrollIntoView({behavior:'smooth',block:'start'});});
